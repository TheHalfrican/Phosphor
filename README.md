...
The Python sidecar is frozen and its runtime components are published. The installer builds
at 40 MB, installs, downloads its runtime on first run, generates, protects title text and
exports. **There is still no download link** while the last rough edges are sorted out.
